        ...
        <div className="todo-wrapper">
          <div >
            ...
            <ul className="classUl">
              {todo.map((todo) => {
                return (
                  <li className="classLi" key={todo.id}>
                    {todo.title}
                    <button
                      ...
                      <div className="modal">
                        ...
                        <div className="modal-content">
                          ...
                          <input className="input2"
                            type="text"
                            placeholder="Enter"
                            onChange={(e) => setEditTodo(todo => ({ ...todo, title: e.target.value }))}
                            value={editTodo.title}
                          />
                          <Select className="edit-select-box2"
          ...
          <div>
            ...
            <ul className="classUl">
              {inprogress.map((inprogress) => {
                return (
                  <li className="classLi" key={inprogress.id}>
                    {inprogress.title}
                    <button
                      className="delete-button"
                      onClick={() => {
          ...
          <div>
            ...
            <ul className="classUl">
              {done.map((done) => {
                return (
                  <li className="classLi" key={done.id}>
                    {done.title}
                    <button
                      className="delete-button"
                      onClick={() => {
